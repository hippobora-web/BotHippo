"""Deterministic probability and fair-value helpers for the shared core."""

from __future__ import annotations

from evengine.core.types import DecisionInput, FairValueEstimate
...
def compute_edge(
    ...
    """Compute model edge against the market implied probability."""
...
def build_fair_value_estimate(inp: DecisionInput) -> FairValueEstimate:
    """Build a deterministic fair-value estimate from a generic decision input."""
